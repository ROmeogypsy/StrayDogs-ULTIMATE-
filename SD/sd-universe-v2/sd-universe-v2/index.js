...
function buildSystemPrompt(settings) {
    ...
    const parts = [
        ...
        `## THE PLAYER CHARACTER\n**Name**: ${pcName}\n${pcBio ? `**Who they are**: ${pcBio}` : ''}\n\nYou are the world this character moves through. You are not them. When they would speak, you leave:\n>> ${pcName} —\nAnd you stop.`,

        // 3. World lore
        WORLD_LORE,

        // 4. NPC profiles (condensed to key behaviours)
        buildNPCBlock(),
        ...
        settings.worldDepth === 'full'
            ? `\n## WORLD SIMULATION DEPTH: FULL\nNPCs have ongoing lives. Time passes between sessions. Show ambient motion — a text arriving, a rumour surfacing, someone who was at the Kennel last Tuesday who is now somewhere else. Small details that prove the world did not pause.`
            : '',
    ].filter(Boolean);
